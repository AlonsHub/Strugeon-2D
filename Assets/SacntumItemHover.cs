...
public class SacntumItemHover : HoverableWithBox
{
    ...
    private void FixLocalPos()
    {
        ...
        {
            basicDisplayer.transform.localPosition = new Vector3(basicDisplayer.transform.localPosition.x, topY, basicDisplayer.transform.localPosition.z);
        }
        else
        {
            basicDisplayer.transform.localPosition = new Vector3(basicDisplayer.transform.localPosition.x, bottomY, basicDisplayer.transform.localPosition.z);
        }
    }
