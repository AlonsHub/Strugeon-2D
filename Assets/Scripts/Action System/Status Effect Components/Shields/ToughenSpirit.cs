...
//public class ToughenSpirit : StatusEffectComponent //should be an attacher
//{
//    [SerializeField]
...
//    public void SetFullEffect(Pawn target, string buffIconName, int newMaxTTL, float dmgMod)
//    {
