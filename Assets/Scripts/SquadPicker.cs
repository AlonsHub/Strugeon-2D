...
public class SquadPicker : MonoBehaviour
{
    ...
    //    {
    //        //if (!PlayerDataMaster.Instance.currentPlayerData.rooms[i].squad.isAvailable)
    //        if (!PlayerDataMaster.Instance.currentPlayerData.rooms[i].squad.IsNotEmptyAndAvailable)
    //        {
    //            squadSlots[i].UnSetMe();
    //            continue;
    //        }

    //        squadSlots[count].SetMe(PlayerDataMaster.Instance.currentPlayerData.rooms[i].squad);
    //        count++;
    //    }
    //}
