...
public class SiteDisplayer : MonoBehaviour
{
    ...
    public void SetMe(SiteButton sb) //TBF siteButton realtions are poblematic - they each have a sitedisplayer, why are they like thissss //lol im on it
    {
     ...
     public void SetMe(NewSiteButton nsb) //TBF siteButton realtions are poblematic - they each have a sitedisplayer, why are they like thissss //lol im on it
    {
        newSiteButton = nsb;
    ...
    public void SetMe(NewSiteButton nsb, int exposureLevel)
    {
        newSiteButton = nsb;
        levelData = nsb.levelSO.levelData;
